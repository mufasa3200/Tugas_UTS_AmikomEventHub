    ...
    <section id="events" class="max-w-7xl mx-auto px-6 py-20">
        <div class="flex justify-between items-end mb-12">
            ...
            <div class="flex gap-4 justify-center">
                <a href="/" class="px-4 py-2 bg-gray-200 hover:bg-gray-300 rounded-xl text-black transition font-bold">Semua Kategori</a>

                @foreach($categories as $cat)
                    <a href="/?category={{ $cat->slug }}" 
                    class="px-4 py-2 bg-indigo-100 hover:bg-indigo-200 text-indigo-700 rounded-xl shadow-sm transition font-bold">
                        {{ $cat->name }}
                    </a>
                @endforeach
            </div>
